...
<head> 
    ...
    <title>Campus Lingüística Universidad de Zaragoza - Baja Usuario</title> 
	...
	<script type="text/javascript">
		...
		function seleccionado() {
			...
			if (idAsignatura != 0){	
				$(document).ready(function(){
						$("#alumnosAAnular").load("validacionAlumnos.php",{mostrar_alumnos_inscritos:"si",idAsignatura:idAsignatura});
				})	
			}
			else
			{
		...
		function DarDeBaja(e) {
			if(e.checked==true)
			{
				...
				var alumno = e.value;
				$(document).ready(function(){
						$("#alumnosAAnular").load("validacionAlumnos.php",{baja:"si",alumno:alumno,idAsignatura:idAsignatura});
				})
			}
		}
...
<body> 
	...
	<div class="Main">
		...
		<h1>Seleccione la asignatura donde quiere dar de baja alumnos: </h1>
